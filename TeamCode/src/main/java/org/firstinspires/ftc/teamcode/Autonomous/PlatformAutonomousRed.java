...
@Autonomous(name="Platform Autonomous Red", group="Tungsteel 2019-20")
//@Disabled
public class PlatformAutonomousRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        sleep(1000);
        robot.mechanumSimpleAuto(0f, -0.45f, 0.5f, -90f, 2250);
