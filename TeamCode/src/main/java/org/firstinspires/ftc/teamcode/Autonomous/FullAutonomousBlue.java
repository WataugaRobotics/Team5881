...
@Autonomous(name="Full Autonomous Blue", group="Tungsteel 2019-20")
//@Disabled
public class FullAutonomousBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot.mechanumSimpleAuto(0f, 0.5f, 0.5f, 90f, 5250 + offset);
        ...
        robot.mechanumSimpleAuto(0f, -0.4f, 0.75f, 90f, 2000);
        robot.mechanumSimpleAuto(0f, 0.5f, 0.5f, 90f, 1750);
        ...
        robot.mechanumSimpleAuto(0.3f, -1f, 0.5f, 90f, 1750);
